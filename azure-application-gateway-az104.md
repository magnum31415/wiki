...
|---|---|---|---|
| Public IP | Entrada Internet | Dirección IP pública que expone el Application Gateway a Internet. Es un recurso Azure independiente ``Microsoft.Network/publicIPAddresses``| `52.168.x.x` |
