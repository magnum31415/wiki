...
````sql
ALTER DATABASE ADD STANDBY LOGFILE GROUP 4 '/u02/oradata/DIGITAL/stby04.log' SIZE 50M;
ALTER DATABASE ADD STANDBY LOGFILE GROUP 5 '/u02/oradata/DIGITAL/stby05.log' SIZE 50M;
ALTER DATABASE ADD STANDBY LOGFILE GROUP 6 '/u02/oradata/DIGITAL/stby06.log' SIZE 50M;
ALTER DATABASE ADD STANDBY LOGFILE GROUP 7 '/u02/oradata/DIGITAL/stby07.log' SIZE 50M;
````
