...
| **Tenant**                  | Instancia dedicada de Microsoft Entra ID que representa a una organización en la nube | Espacio aislado donde se gestionan identidades, usuarios, dominios y acceso a servicios como Azure o Microsoft 365. | El tenant **company.com** donde se gestionan usuarios, grupos y aplicaciones corporativas. |
