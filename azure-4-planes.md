...
| **Control Plane**  | `management.azure.com`      | Azure Resource Manager (ARM)                                    | ✅ Sí. API REST para crear, modificar y administrar recursos de Azure. Es el punto de entrada (endpoint) de Azure Resource Manager (ARM), y ARM enruta las peticiones al Resource Provider correspondiente.
|
